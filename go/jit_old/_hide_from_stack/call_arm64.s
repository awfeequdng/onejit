...
TEXT ·GrowStack(SB), 0,
    ...
    NOSPLIT | NOFRAME,
    $0 - 8 NO_LOCAL_POINTERS RET

        /**
         * call the closure stored in R26 (which expects exactly 0 bytes of
         * arguments
    ...
    /*
     * as above, but closure can expect up to 16 bytes of arguments return
     * values and stack does not have padding: hidden_return_addr-0x8(SP):  R30,
     * stored by call16 itself caller_return_addr-0x10(SP): R30, stored&read by
     * caller closure_arg_or_ret-0x18(SP):      stored&read by caller
    ...
    $0x20 - 0
        ...
        NO_LOCAL_POINTERS MOVD R30,
    hidden_return_addr - 0x8(SP)MOVD caller_return_addr - 0x10(SP), R0 MOVD R0,
    return_addr - 0x28(SP)MOVD 0(R26),
    R1 CALL R1 WORD $0xF85F83FD  // ldur    x29, [sp, #-8]
        MOVD hidden_return_addr
        - 0x8(SP),
    R30 WORD $0x9100C3FF  // add     sp, sp, #0x30
    WORD $0xD65F03C0      // ret
    ...
    $0x30 - 0
        ...
        NO_LOCAL_POINTERS MOVD R30,
    hidden_return_addr - 0x8(SP)MOVD caller_return_addr - 0x10(SP), R0 MOVD R0,
    return_addr - 0x38(SP)MOVD 0(R26),
    R1 CALL R1 WORD $0xF85F83FD  // ldur    x29, [sp, #-8]
        MOVD hidden_return_addr
        - 0x8(SP),
    R30 WORD $0x910103ff  // add     sp, sp, #0x40
    WORD $0xD65F03C0      // ret
    ...
    $0x50 - 0
        ...
        NO_LOCAL_POINTERS MOVD R30,
    hidden_return_addr - 0x8(SP)MOVD caller_return_addr - 0x10(SP), R0 MOVD R0,
    return_addr - 0x58(SP)MOVD 0(R26),
    R1 CALL R1 WORD $0xF85F83FD  // ldur    x29, [sp, #-8]
        MOVD hidden_return_addr
        - 0x8(SP),
    R30 WORD $0x910183ff  // add     sp, sp, #0x60
    WORD $0xD65F03C0      // ret
    ...
    $0x90 - 0
        ...
        NO_LOCAL_POINTERS MOVD R30,
    hidden_return_addr - 0x8(SP)MOVD caller_return_addr - 0x10(SP), R0 MOVD R0,
    return_addr - 0x98(SP)MOVD 0(R26),
    R1 CALL R1 WORD $0xF85F83FD  // ldur    x29, [sp, #-8]
        MOVD hidden_return_addr
        - 0x8(SP),
    R30 WORD $0x910283ff  // add     sp, sp, #0xA0
    WORD $0xD65F03C0      // ret
    ...
    $0x110 - 0
        ...
        NO_LOCAL_POINTERS MOVD R30,
    hidden_return_addr - 0x8(SP)MOVD caller_return_addr - 0x10(SP), R0 MOVD R0,
    return_addr - 0x118(SP)MOVD 0(R26),
    R1 CALL R1 WORD $0xF85F83FD  // ldur    x29, [sp, #-8]
        MOVD hidden_return_addr
        - 0x8(SP),
    R30 WORD $0x910483ff  // add     sp, sp, #0x120
    WORD $0xD65F03C0      // ret
    ...
    $0x210 - 0
        ...
        NO_LOCAL_POINTERS MOVD R30,
    hidden_return_addr - 0x8(SP)MOVD caller_return_addr - 0x10(SP), R0 MOVD R0,
    return_addr - 0x218(SP)MOVD 0(R26),
    R1 CALL R1 WORD $0xF85F83FD  // ldur    x29, [sp, #-8]
        MOVD hidden_return_addr
        - 0x8(SP),
    R30 WORD $0x910883ff  // add     sp, sp, #0x220
    WORD $0xD65F03C0      // ret
